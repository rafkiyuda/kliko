...
export const MOCK_TUKANGS: MockTukang[] = [
  ...
  },
  {
    ...
    avatar: "/images/tukang-asep.jpg",
    badge: "SILVER",
    specialties: ["Plumbing & Pipa Mampet", "Instalasi Pompa & Toren", "Kran & Sanitary", "Plumbing & Sanitari"],
    yearsExperience: 7,
    completedJobs: 189,
    rating: 4.85,
    reviewCount: 145,
  ...
  },
  {
    ...
    avatar: "/images/tukang-joko.jpg",
    badge: "GOLD_MASTER",
    specialties: ["Elektronik & AC", "Service & Cuci AC", "Reparasi AC Bocor & Freon", "HVAC"],
    yearsExperience: 11,
    completedJobs: 412,
    rating: 4.97,
    reviewCount: 320,
    dailyRate: 210000,
    location: "Jakarta Selatan, Depok & Tangsel",
    isVerified: true,
    bio: "Teknisi AC bersertifikasi BNSP HVAC dengan pengalaman 11 tahun menangani AC menetes, kompresor bising, tambah freon R32/R410A, dan instalasi AC multi-split.",
  },
  {
    id: "tukang-6",
    name: "Mas Ilham Prasetyo",
    avatar: "/images/tukang-asep.jpg",
    badge: "SILVER",
    specialties: ["Elektronik & AC", "Service & Cuci AC", "Kelistrikan"],
    yearsExperience: 6,
    completedJobs: 178,
    rating: 4.89,
    reviewCount: 132,
    ...
    isVerified: true,
    bio: "Spesialis cuci steam AC bertekanan tinggi, bongkar pasang AC perumahan, dan perbaikan modul kelistrikan inverter.",
  },
];
...
export const MOCK_SERVICES: MockService[] = [
  ...
  {
    id: "srv-7",
    title: "Service, Cuci & Reparasi AC Menetes / Tidak Dingin",
    category: "Elektronik & AC",
    description: "Pembersihan evaporator/blower indoor-outdoor, flushing saluran pipa pembuangan air kondensasi tersumbat, uji tekanan freon, dan perbaikan tetesan air.",
    priceType: "per_titik",
    basePrice: 85000,
    unit: "unit",
    estimatedHours: 2,
    ...
    imageUrl: "/images/cat-dinding.jpg",
    includedScope: [
      "Cuci steam evaporator indoor & outdoor",
      "Flushing pipa pembuangan air anti-tersumbat",
      "Pengecekan amper kompresor & tekanan freon",
      "Garansi cuci & dingin 14 hari",
    ],
    warrantyDays: 14,
    popular: true,
  },
